...
public class MediaSessionCompat {
    ...
    public MediaSessionCompat(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, Bundle bundle, VersionedParcelable versionedParcelable) {
        ...
        if (componentName != null && pendingIntent == null) {
            ...
            pendingIntent = PendingIntent.getBroadcast(context, 0, intent, Build.VERSION.SDK_INT >= 31 ? SemanticsLevelOneType.CONTROL : 0);
        }
    ...
    static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        ...
        RemoteControlClient.MetadataEditor buildRccMetadata(Bundle bundle) {
            ...
            if (((this.mState == null ? 0L : this.mState.getActions()) & 128) != 0) {
                metadataEditorBuildRccMetadata.addEditableKey(SemanticsType.QUERY_SONG);
            }
            if (bundle == null) {
            ...
            if (bundle.containsKey(MediaMetadataCompat.METADATA_KEY_USER_RATING)) {
                metadataEditorBuildRccMetadata.putObject(SemanticsType.QUERY_SONG, (Object) bundle.getParcelable(MediaMetadataCompat.METADATA_KEY_USER_RATING));
            }
            return metadataEditorBuildRccMetadata;
        }
    }
