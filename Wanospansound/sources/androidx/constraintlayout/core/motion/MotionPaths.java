...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    void getCenter(double d2, int[] iArr, double[] dArr, float[] fArr, int i) {
        ...
        if (motion != null) {
            ...
            double d4 = fSin;
            double d5 = fCos;
            fSin = (float) ((d3 + (Math.sin(d5) * d4)) - ((double) (f / 2.0f)));
            fCos = (float) ((((double) f5) - (d4 * Math.cos(d5))) - ((double) (f2 / 2.0f)));
        }
    ...
    void getCenter(double d2, int[] iArr, double[] dArr, float[] fArr, double[] dArr2, float[] fArr2) {
        ...
        if (motion != null) {
            ...
            double d4 = f3;
            f = f4;
            float fSin = (float) ((((double) f14) + (Math.sin(d4) * d3)) - ((double) (f4 / 2.0f)));
            float fCos2 = (float) ((((double) f15) - (d3 * Math.cos(d4))) - ((double) (f5 / 2.0f)));
            double d5 = f6;
            double d6 = f8;
            float fSin2 = (float) (((double) f16) + (Math.sin(d4) * d5) + (Math.cos(d4) * d6));
            fCos = (float) ((((double) f17) - (d5 * Math.cos(d4))) + (Math.sin(d4) * d6));
            f13 = fSin2;
            f2 = fSin;
            f3 = fCos2;
            f12 = 2.0f;
    ...
    void setView(float f, MotionWidget motionWidget, int[] iArr, double[] dArr, double[] dArr2, double[] dArr3) {
        ...
        if (motion != null) {
            ...
            f3 = f8;
            if (!Float.isNaN(f16)) {
                motionWidget.setRotationZ((float) (((double) 0.0f) + ((double) f16) + Math.toDegrees(Math.atan2(f11 + (f13 / 2.0f), f10 + (f12 / 2.0f)))));
            }
        }
        float f21 = f5 + 0.5f;
        float f22 = f6 + 0.5f;
