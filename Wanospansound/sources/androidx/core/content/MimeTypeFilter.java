...
public final class MimeTypeFilter {
    ...
    public static boolean matches(String str, String str2) {
        ...
        return mimeTypeAgainstFilter(str.split(BceConfig.BOS_DELIMITER), str2.split(BceConfig.BOS_DELIMITER));
    }
    ...
    public static String matches(String str, String[] strArr) {
        ...
        for (String str2 : strArr) {
            if (mimeTypeAgainstFilter(strArrSplit, str2.split(BceConfig.BOS_DELIMITER))) {
                return str2;
            }
        }
        return null;
    ...
    public static String matches(String[] strArr, String str) {
        ...
        String[] strArrSplit = str.split(BceConfig.BOS_DELIMITER);
        for (String str2 : strArr) {
            if (mimeTypeAgainstFilter(str2.split(BceConfig.BOS_DELIMITER), strArrSplit)) {
                return str2;
            }
        }
        return null;
