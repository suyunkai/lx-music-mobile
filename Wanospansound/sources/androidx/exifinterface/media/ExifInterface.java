...
public class ExifInterface {
    ...
    static {
        ...
        ExifTag[] exifTagArr8 = {new ExifTag(TAG_ORF_ASPECT_FRAME, BaseRecycleAdapter.ITEM_TYPE_FOOTER, 3)};
        ORF_IMAGE_PROCESSING_TAGS = exifTagArr8;
        ExifTag[] exifTagArr9 = {new ExifTag(TAG_COLOR_SPACE, 55, 3)};
        PEF_TAGS = exifTagArr9;
        ExifTag[][] exifTagArr10 = {exifTagArr, exifTagArr2, exifTagArr3, exifTagArr4, exifTagArr5, exifTagArr, exifTagArr6, exifTagArr7, exifTagArr8, exifTagArr9};
        EXIF_TAGS = exifTagArr10;
        EXIF_POINTER_TAGS = new ExifTag[]{new ExifTag(TAG_SUB_IFD_POINTER, ECarXAPIBase.SUPPORT_AUTH_VERSION, 4), new ExifTag(TAG_EXIF_IFD_POINTER, 34665, 4), new ExifTag(TAG_GPS_INFO_IFD_POINTER, 34853, 4), new ExifTag(TAG_INTEROPERABILITY_IFD_POINTER, 40965, 4), new ExifTag(TAG_ORF_CAMERA_SETTINGS_IFD_POINTER, 8224, 1), new ExifTag(TAG_ORF_IMAGE_PROCESSING_IFD_POINTER, 8256, 1)};
    ...
    private static class Rational {
        ...
        Rational(double d2) {
            this((long) (d2 * 10000.0d), Renderer.DEFAULT_DURATION_TO_PROGRESS_US);
        }
        ...
        public String toString() {
            return this.numerator + BceConfig.BOS_DELIMITER + this.denominator;
        }
                    ...
                    switch (i) {
                        ...
                        case 5:
                            ...
                            while (i10 < strArrSplit3.length) {
                                String[] strArrSplit4 = strArrSplit3[i10].split(BceConfig.BOS_DELIMITER, i7);
                        ...
                        case 10:
                            ...
                            while (i12 < strArrSplit6.length) {
                                String[] strArrSplit7 = strArrSplit6[i12].split(BceConfig.BOS_DELIMITER, -1);
    ...
    */
    ...
    private static double convertRationalLatLonToDouble(String str, String str2) {
        try {
            ...
            String[] strArrSplit2 = strArrSplit[0].split(BceConfig.BOS_DELIMITER, -1);
            double d2 = Double.parseDouble(strArrSplit2[0].trim()) / Double.parseDouble(strArrSplit2[1].trim());
            String[] strArrSplit3 = strArrSplit[1].split(BceConfig.BOS_DELIMITER, -1);
            double d3 = Double.parseDouble(strArrSplit3[0].trim()) / Double.parseDouble(strArrSplit3[1].trim());
            String[] strArrSplit4 = strArrSplit[2].split(BceConfig.BOS_DELIMITER, -1);
    ...
    */
    ...
    private static Pair<Integer, Integer> guessDataFormat(String str) {
        ...
        if (str.contains(BceConfig.BOS_DELIMITER)) {
            String[] strArrSplit2 = str.split(BceConfig.BOS_DELIMITER, -1);
