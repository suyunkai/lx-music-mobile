...
public final class ColorInfo {
    ...
    public String toLogString() {
        return (isDataSpaceValid() ? Util.formatInvariant("%s/%s/%s", colorSpaceToString(this.colorSpace), colorRangeToString(this.colorRange), colorTransferToString(this.colorTransfer)) : "NA/NA/NA") + BceConfig.BOS_DELIMITER + (isBitdepthValid() ? this.lumaBitdepth + BceConfig.BOS_DELIMITER + this.chromaBitdepth : "NA/NA");
    }
