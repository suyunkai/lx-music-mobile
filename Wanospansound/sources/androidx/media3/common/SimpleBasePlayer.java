...
public abstract class SimpleBasePlayer extends BasePlayer {
    ...
    protected SimpleBasePlayer(Looper looper, Clock clock) {
        ...
        this.listeners = new ListenerSet<>(looper, clock, new ListenerSet.IterationFinishedEvent() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda47
            ...
            public final void invoke(Object obj, FlagSet flagSet) {
                this.f$0.m50lambda$new$0$androidxmedia3commonSimpleBasePlayer((Player.Listener) obj, flagSet);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$new$0$androidx-media3-common-SimpleBasePlayer, reason: not valid java name */
    /* synthetic */ void m50lambda$new$0$androidxmedia3commonSimpleBasePlayer(Player.Listener listener, FlagSet flagSet) {
    ...
    @RequiresNonNull({IServiceManager.SERVICE_STATE})
    private void setMediaItemsInternal(final List<MediaItem> list, final int i, final long j) {
        ...
        if (shouldHandleCommand(20) || (list.size() == 1 && shouldHandleCommand(31))) {
            updateStateForPendingOperation(handleSetMediaItems(list, i, j), new Supplier() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda62
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    return this.f$0.m53x396b5ff4(list, state, i, j);
                }
            });
        }
    }
    ...
    /* synthetic */ State m53x396b5ff4(List list, State state, int i, long j) {
    ...
    public final void addMediaItems(int i, final List<MediaItem> list) {
        ...
        updateStateForPendingOperation(handleAddMediaItems(iMin, list), new Supplier() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda56
            @Override // com.google.common.base.Supplier
            public final Object get() {
                return this.f$0.m48lambda$addMediaItems$3$androidxmedia3commonSimpleBasePlayer(state, list, iMin);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$addMediaItems$3$androidx-media3-common-SimpleBasePlayer, reason: not valid java name */
    /* synthetic */ State m48lambda$addMediaItems$3$androidxmedia3commonSimpleBasePlayer(State state, List list, int i) {
    ...
    public final void moveMediaItems(final int i, int i2, int i3) {
        ...
        updateStateForPendingOperation(handleMoveMediaItems(i, iMin, iMin2), new Supplier() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda51
            @Override // com.google.common.base.Supplier
            public final Object get() {
                return this.f$0.m49lambda$moveMediaItems$4$androidxmedia3commonSimpleBasePlayer(state, i, iMin, iMin2);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$moveMediaItems$4$androidx-media3-common-SimpleBasePlayer, reason: not valid java name */
    /* synthetic */ State m49lambda$moveMediaItems$4$androidxmedia3commonSimpleBasePlayer(State state, int i, int i2, int i3) {
        ArrayList arrayList = new ArrayList(state.playlist);
    ...
    protected ListenableFuture<?> handleReplaceMediaItems(int i, int i2, List<MediaItem> list) {
        ...
        return Util.transformFutureAsync(listenableFutureHandleAddMediaItems, new AsyncFunction() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda43
    ...
    @EnsuresNonNull({IServiceManager.SERVICE_STATE})
    ...
    private void updateStateForPendingOperation(final ListenableFuture<?> listenableFuture, Supplier<State> supplier, boolean z, boolean z2) {
        ...
        listenableFuture.addListener(new Runnable() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda45
            ...
            public final void run() {
                this.f$0.m54x9bf3217a(listenableFuture);
            }
    ...
    /* synthetic */ void m54x9bf3217a(ListenableFuture listenableFuture) {
