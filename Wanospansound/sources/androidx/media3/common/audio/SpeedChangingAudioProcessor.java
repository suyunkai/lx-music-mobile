...
public final class SpeedChangingAudioProcessor extends BaseAudioProcessor {
    ...
    public void queueInput(ByteBuffer byteBuffer) {
        ...
        long jScaleLargeTimestamp = Util.scaleLargeTimestamp(this.bytesRead, 1000000L, ((long) this.inputAudioFormat.sampleRate) * ((long) this.inputAudioFormat.bytesPerFrame));
    ...
    private void updateLastProcessedInputTime() {
        synchronized (this.lock) {
            if (isUsingSonic()) {
                this.lastProcessedInputTimeUs = this.inputSegmentStartTimesUs.get(r3.size() - 1) + Util.scaleLargeTimestamp(this.sonicAudioProcessor.getProcessedInputBytes(), 1000000L, ((long) this.inputAudioFormat.sampleRate) * ((long) this.inputAudioFormat.bytesPerFrame));
            } else {
