...
public class LottieAnimationView extends AppCompatImageView {
        ...
        if (isInEditMode()) {
            return new LottieTask<>(new Callable() { // from class: com.airbnb.lottie.LottieAnimationView$$ExternalSyntheticLambda0
                ...
                public final Object call() {
                    return this.f$0.m207lambda$fromRawRes$1$comairbnblottieLottieAnimationView(i);
                }
            }, true);
        }
    ...
    /* synthetic */ LottieResult m207lambda$fromRawRes$1$comairbnblottieLottieAnimationView(int i) throws Exception {
    ...
    private LottieTask<LottieComposition> fromAssets(final String str) {
        if (isInEditMode()) {
            return new LottieTask<>(new Callable() { // from class: com.airbnb.lottie.LottieAnimationView$$ExternalSyntheticLambda3
                @Override // java.util.concurrent.Callable
                public final Object call() {
                    return this.f$0.m206lambda$fromAssets$2$comairbnblottieLottieAnimationView(str);
                }
            }, true);
        }
    ...
    /* synthetic */ LottieResult m206lambda$fromAssets$2$comairbnblottieLottieAnimationView(String str) throws Exception {
