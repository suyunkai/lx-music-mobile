...
public class BceClientConfiguration {
    ...
    public static long MAX_PARTS = Renderer.DEFAULT_DURATION_TO_PROGRESS_US;
    ...
    static {
        ...
        DEFAULT_USER_AGENT = JoinerUtils.on(BceConfig.BOS_DELIMITER, "bce-sdk-android", BceConfig.VERSION, System.getProperty("os.name"), System.getProperty("os.version"), System.getProperty("java.vm.name"), System.getProperty("java.vm.version"), System.getProperty("java.version"), property, property2 != null ? property2 : "").replace(TokenParser.SP, '_');
    }
    ...
    public BceClientConfiguration() {
        ...
        this.dns = null;
        this.ipv4Priority = false;
        this.uploadSegmentPart = 2048L;
        this.multipartBlockSize = 10485760L;
        this.uploadRetry = 3;
    }
    ...
    public String getEndpoint() {
        ...
        return (str == null || str.length() <= 0 || this.endpoint.indexOf("://") >= 0) ? str : this.protocol.toString().toLowerCase() + "://" + this.endpoint;
    }
    ...
    public Boolean getIpv4Priority() {
        return this.ipv4Priority;
    }

    public void setIpv4Priority(Boolean bool) {
        this.ipv4Priority = bool;
    }
