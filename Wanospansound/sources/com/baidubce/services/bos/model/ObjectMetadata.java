...
public class ObjectMetadata {
    ...
    public ObjectMetadata(ObjectMetadata objectMetadata) {
        ...
        setxBceAcl(objectMetadata.getxBceAcl());
    }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("ObjectMetadata [userMetadata=");
        ...
        if (this.xBceAcl != null) {
            sb.append(", xBceAcl=").append(this.xBceAcl);
        }
        sb.append(']');
        return sb.toString();
    }
    ...
    public void setxBceAcl(String str) {
        this.xBceAcl = str;
    }
}
