...
public final class ConvertUtils {
    ...
    public static byte[] bits2Bytes(String str) {
        ...
        for (int i = 0; i < length2; i++) {
            for (int i2 = 0; i2 < 8; i2++) {
                ...
                bArr[i] = b2;
                bArr[i] = (byte) (b2 | (str.charAt((i * 8) + i2) - '0'));
            }
        }
        return bArr;
    }
    ...
    */
    ...
    public static String byte2FitMemorySize(long j, int i) {
        ...
        if (j >= 0) {
            return j < 1024 ? String.format("%." + i + "fB", Double.valueOf(j)) : j < PlaybackStateCompat.ACTION_SET_CAPTIONING_ENABLED ? String.format("%." + i + "fKB", Double.valueOf(j / 1024.0d)) : j < IjkMediaMeta.AV_CH_STEREO_RIGHT ? String.format("%." + i + "fMB", Double.valueOf(j / 1048576.0d)) : String.format("%." + i + "fGB", Double.valueOf(j / 1.073741824E9d));
        }
