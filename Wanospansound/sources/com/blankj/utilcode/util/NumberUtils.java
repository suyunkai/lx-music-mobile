...
public final class NumberUtils {
    ...
    public static String format(double d2, int i) {
        return format(d2, false, 1, i, true);
    }

    public static String format(double d2, int i, boolean z) {
        return format(d2, false, 1, i, z);
    }

    public static String format(double d2, int i, int i2, boolean z) {
        return format(d2, false, i, i2, z);
    }

    public static String format(double d2, boolean z, int i) {
        return format(d2, z, 1, i, true);
    }

    public static String format(double d2, boolean z, int i, boolean z2) {
        return format(d2, z, 1, i, z2);
    }

    public static String format(double d2, boolean z, int i, int i2, boolean z2) {
