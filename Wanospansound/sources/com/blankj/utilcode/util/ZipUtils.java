...
public final class ZipUtils {
        ...
        try {
            if (UtilsBridge.isSpace(str)) {
                while (enumerationEntries.hasMoreElements()) {
                    ...
                    String strReplace = zipEntryNextElement.getName().replace("\\", BceConfig.BOS_DELIMITER);
                ...
                while (enumerationEntries.hasMoreElements()) {
                    ...
                    String strReplace2 = zipEntryNextElement2.getName().replace("\\", BceConfig.BOS_DELIMITER);
    ...
    */
    ...
    public static List<String> getFilesPath(File file) throws IOException {
        ...
        Enumeration<? extends ZipEntry> enumerationEntries = zipFile.entries();
        while (enumerationEntries.hasMoreElements()) {
            String strReplace = enumerationEntries.nextElement().getName().replace("\\", BceConfig.BOS_DELIMITER);
            if (strReplace.contains("../")) {
                Log.e("ZipUtils", "entryName: " + strReplace + " is dangerous!");
