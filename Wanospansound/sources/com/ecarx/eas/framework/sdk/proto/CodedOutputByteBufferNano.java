...
public final class CodedOutputByteBufferNano {
        ...
        try {
            ...
            if (iComputeRawVarint32Size == computeRawVarint32Size(str.length() * 3)) {
                ...
                if (this.buffer.remaining() < iComputeRawVarint32Size) {
                    throw new a(iPosition + iComputeRawVarint32Size, this.buffer.limit());
                }
            ...
            a aVar = new a(this.buffer.position(), this.buffer.limit());
            aVar.initCause(e);
            throw aVar;
        }
    }
    ...
    public final void writeRawByte(byte b2) throws IOException {
        if (!this.buffer.hasRemaining()) {
            throw new a(this.buffer.position(), this.buffer.limit());
        }
        this.buffer.put(b2);
    }
