...
public final class d extends c.a implements IRightTurnLight {
    ...
    public d(com.ecarx.eas.sdk.vehicle.api.a aVar, String str, String str2) {
        super(aVar, str, str2);
    }
    ...
    protected final String a(String str) {
        if ("registerCallback".equals(str)) {
            return "registerRightTurnLightCallback";
        }
        if ("unregisterCallback".equals(str)) {
            return "unregisterRightTurnLightCallback";
        }
        return null;
    }
