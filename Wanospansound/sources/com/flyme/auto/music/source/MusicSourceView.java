...
import com.flyme.auto.music.source.MusicSourcePopupWindow;
...
public class MusicSourceView extends FrameLayout {
    ...
    public MusicSourceView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.musicSourceCallback = new MusicSourceRepository.MusicSourceCallback() { // from class: com.flyme.auto.music.source.MusicSourceView.1
    ...
    public void setClickAble(boolean z) {
        ...
        if (z) {
            ...
            viewFindViewById.setOnClickListener(new View.OnClickListener() { // from class: com.flyme.auto.music.source.MusicSourceView$$ExternalSyntheticLambda2
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.m242x1beda6f0(view);
                }
            });
            return;
        }
    ...
    /* JADX INFO: renamed from: lambda$setClickAble$0$com-flyme-auto-music-source-MusicSourceView, reason: not valid java name */
    /* synthetic */ void m242x1beda6f0(View view) {
        if (clickDebounce()) {
            toggleSelector();
        } else {
    ...
    private void initPopupWindow(List<MusicSourceEntity> list) {
        synchronized (this.musicSourceList) {
            ...
            if (musicSourcePopupWindow == null || !musicSourcePopupWindow.isShowing() || this.rebuildPopupWindow) {
                ...
                this.popupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() { // from class: com.flyme.auto.music.source.MusicSourceView$$ExternalSyntheticLambda0
                    @Override // android.widget.PopupWindow.OnDismissListener
                    public final void onDismiss() {
                        this.f$0.m239xfc8b0d23();
                    }
                });
                this.popupWindow.setMusicSourceSelectCallback(new MusicSourcePopupWindow.MusicSourceSelectCallback() { // from class: com.flyme.auto.music.source.MusicSourceView$$ExternalSyntheticLambda1
                    @Override // com.flyme.auto.music.source.MusicSourcePopupWindow.MusicSourceSelectCallback
                    public final void onMusicSourceSelect(MusicSourceEntity musicSourceEntity, int i) {
                        this.f$0.m241x31cc9225(musicSourceEntity, i);
                    }
                });
            }
        }
    ...
    /* JADX INFO: renamed from: lambda$initPopupWindow$1$com-flyme-auto-music-source-MusicSourceView, reason: not valid java name */
    /* synthetic */ void m239xfc8b0d23() {
        this.arrowImageView.setRotation(0.0f);
    }

    /* JADX INFO: renamed from: lambda$initPopupWindow$3$com-flyme-auto-music-source-MusicSourceView, reason: not valid java name */
    /* synthetic */ void m241x31cc9225(final MusicSourceEntity musicSourceEntity, final int i) {
        ...
        this.viewRoot.postDelayed(new Runnable() { // from class: com.flyme.auto.music.source.MusicSourceView$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m240x972bcfa4(musicSourceEntity, i);
            }
        }, 250L);
    }

    /* JADX INFO: renamed from: lambda$initPopupWindow$2$com-flyme-auto-music-source-MusicSourceView, reason: not valid java name */
    /* synthetic */ void m240x972bcfa4(MusicSourceEntity musicSourceEntity, int i) {
    ...
    public void applyDefaultDayNightMode(boolean z) {
        MusicSourceLog.d("MusicSource-View", "applyDefaultDayNightMode " + z);
        if (z) {
