...
public class SearchBar extends Toolbar {
    ...
    /* synthetic */ void m304lambda$new$0$comgoogleandroidmaterialsearchSearchBar(boolean z) {
    ...
    public SearchBar(Context context, AttributeSet attributeSet, int i) {
        ...
        this.touchExplorationStateChangeListener = new AccessibilityManagerCompat.TouchExplorationStateChangeListener() { // from class: com.google.android.material.search.SearchBar$$ExternalSyntheticLambda0
            ...
            public final void onTouchExplorationStateChanged(boolean z) {
                this.f$0.m304lambda$new$0$comgoogleandroidmaterialsearchSearchBar(z);
            }
        };
    ...
    private void validateAttributes(AttributeSet attributeSet) {
        ...
        if (attributeSet.getAttributeValue(NAMESPACE_APP, CollectionDialogViewModel.KEY_TITLE) != null) {
