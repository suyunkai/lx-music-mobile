...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    public Excluder withVersion(double d2) {
        Excluder excluderM365clone = m365clone();
        excluderM365clone.version = d2;
        return excluderM365clone;
    }

    public Excluder withModifiers(int... iArr) {
        Excluder excluderM365clone = m365clone();
        excluderM365clone.modifiers = 0;
        for (int i : iArr) {
            excluderM365clone.modifiers = i | excluderM365clone.modifiers;
        }
        return excluderM365clone;
    }
    ...
    public Excluder disableInnerClassSerialization() {
        Excluder excluderM365clone = m365clone();
        excluderM365clone.serializeInnerClasses = false;
        return excluderM365clone;
    }

    public Excluder excludeFieldsWithoutExposeAnnotation() {
        Excluder excluderM365clone = m365clone();
        excluderM365clone.requireExpose = true;
        return excluderM365clone;
    }
    ...
    public Excluder withExclusionStrategy(ExclusionStrategy exclusionStrategy, boolean z, boolean z2) {
        ...
        if (z) {
            ...
            excluderM365clone.serializationStrategies = arrayList;
            arrayList.add(exclusionStrategy);
        }
        if (z2) {
            ArrayList arrayList2 = new ArrayList(this.deserializationStrategies);
            excluderM365clone.deserializationStrategies = arrayList2;
