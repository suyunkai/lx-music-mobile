...
public class MaterialFooterView extends FrameLayout implements MaterialHeadListener {
    ...
    public void setProgressValue(int i) {
        ...
        post(new Runnable() { // from class: com.wanos.MaterialFooterView.1
            @Override // java.lang.Runnable
            public void run() {
                if (MaterialFooterView.this.circleProgressBar != null) {
                    MaterialFooterView.this.circleProgressBar.setProgress(MaterialFooterView.this.progressValue);
                }
            }
        });
    }
