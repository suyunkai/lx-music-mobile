...
public final class LayoutGuide4Binding implements ViewBinding {
    ...
    private LayoutGuide4Binding(ConstraintLayout constraintLayout, TextView textView, TextView textView2, TextView textView3, TextView textView4, View view, View view2) {
    ...
    public static LayoutGuide4Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.layout_guide4, viewGroup, false);
        if (z) {
            ...
            if (textView2 != null) {
                ...
                if (textView3 != null) {
                    ...
                    if (textView4 != null && (viewFindChildViewById = ViewBindings.findChildViewById(view, (i = R.id.view_blue_dot))) != null && (viewFindChildViewById2 = ViewBindings.findChildViewById(view, (i = R.id.view_white_dot))) != null) {
                        return new LayoutGuide4Binding((ConstraintLayout) view, textView, textView2, textView3, textView4, viewFindChildViewById, viewFindChildViewById2);
                    }
                }
            }
        }
