...
public class CreatorHomeAdapter extends BaseRecycleAdapter<ProjectInfo, ViewHolder> implements OnStatusCallbackListener {
    ...
    public CreatorHomeAdapter(Context context, List<ProjectInfo> list) {
        super(list);
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        return new ViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.layout_creator_templete_item, viewGroup, false));
    }
    ...
    public void bindData(final ViewHolder viewHolder, final int i) {
        ...
        if (projectInfo != null) {
            ...
            viewHolder.ivCollect.setOnClickListener(new View.OnClickListener() { // from class: com.wanos.editmain.adapter.CreatorHomeAdapter.1
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    CreatorHomeAdapter.this.collectWork(projectInfo.getId(), projectInfo, viewHolder.ivCollect);
                }
            });
            viewHolder.cvItem.setOnClickListener(new View.OnClickListener() { // from class: com.wanos.editmain.adapter.CreatorHomeAdapter.2
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    CreatorHomeAdapter.this.stopOtherAudio();
                    CreatorHomeAdapter.this.stopPlayer();
                    String wanosPath = projectInfo.getWanosPath();
                    Intent intent = new Intent(CreatorHomeAdapter.this.context, (Class<?>) WanosPlayerActivity.class);
                    intent.putExtra("projectInfo", projectInfo);
                    intent.putExtra("type", 1);
                    intent.putExtra("URL", wanosPath);
                    intent.putExtra("ID", projectInfo.getId());
                    intent.putExtra("JSONPATH", projectInfo.getHistoryPath());
                    intent.putExtra("DURATION", projectInfo.getDuration());
                    intent.putExtra("EDIT", true);
                    intent.putExtra("NAME", projectInfo.getTitle());
                    CreatorHomeAdapter.this.context.startActivity(intent);
                }
            });
            viewHolder.ivEditBg.setOnClickListener(new View.OnClickListener() { // from class: com.wanos.editmain.adapter.CreatorHomeAdapter.3
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (CreatorHomeAdapter.this.clickBtn) {
                        return;
                    }
                    CreatorHomeAdapter.this.clickBtn = true;
                    CreatorHomeAdapter.this.stopOtherAudio();
                    CreatorHomeAdapter.this.stopPlayer();
                    CreatorRetrofitUtil.workCopy(projectInfo.getId(), new ResponseCallBack<EditProjectCopyResponse>(CreatorHomeAdapter.this.context) { // from class: com.wanos.editmain.adapter.CreatorHomeAdapter.3.1
                        @Override // com.wanos.WanosCommunication.ResponseCallBack
                        public void onResponseSuccessful(EditProjectCopyResponse editProjectCopyResponse) {
                            CreatorHomeAdapter.this.clickBtn = false;
                            if (editProjectCopyResponse.data != null) {
                                EditingActivity.openEditActivity(CreatorHomeAdapter.this.context, editProjectCopyResponse.data.getProjectType(), editProjectCopyResponse.data.getId(), new Gson().toJson(editProjectCopyResponse.data));
                            }
                        }
            ...
            viewHolder.btnPlay.setOnTouchListener(new View.OnTouchListener() { // from class: com.wanos.editmain.adapter.CreatorHomeAdapter.4
                @Override // android.view.View.OnTouchListener
                public boolean onTouch(View view, MotionEvent motionEvent) {
                    if (CreatorHomeAdapter.this.playingProjectId.equals("") || !CreatorHomeAdapter.this.playingProjectId.equals(projectInfo.getId())) {
                        EditingUtils.log("holder.ivPlayState 0");
                        CreatorHomeAdapter.this.stopOtherAudio();
                        CreatorHomeAdapter.this.initPlayer(projectInfo.getWanosPath(), projectInfo.getId(), i, projectInfo);
                        return false;
                    }
                    EditingUtils.log("holder.ivPlayState 1");
                    if (CreatorHomeAdapter.this.mMediaPlayerHelper == null) {
                        return false;
                    }
                    CreatorHomeAdapter.this.playingProjectId = "";
                    CreatorHomeAdapter.this.mMediaPlayerHelper.pause();
                    CreatorHomeAdapter.this.notifyDataSetChangedM();
                    return false;
                }
            });
        }
    ...
    protected void collectWork(String str, final ProjectInfo projectInfo, final ImageView imageView) {
        if (!projectInfo.isCollect()) {
            CreatorRetrofitUtil.workCollect(str, new ResponseCallBack<BaseResponse>(this.context) { // from class: com.wanos.editmain.adapter.CreatorHomeAdapter.5
                @Override // com.wanos.WanosCommunication.ResponseCallBack
                public void onResponseSuccessful(BaseResponse baseResponse) {
                    projectInfo.setCollect(!r3.isCollect());
                    CreatorHomeAdapter.this.updateCollect(projectInfo.isCollect(), imageView);
                }
            ...
            CreatorRetrofitUtil.workCancelCollect(str, new ResponseCallBack<BaseResponse>(this.context) { // from class: com.wanos.editmain.adapter.CreatorHomeAdapter.6
                @Override // com.wanos.WanosCommunication.ResponseCallBack
                public void onResponseSuccessful(BaseResponse baseResponse) {
                    projectInfo.setCollect(!r3.isCollect());
                    CreatorHomeAdapter.this.updateCollect(projectInfo.isCollect(), imageView);
