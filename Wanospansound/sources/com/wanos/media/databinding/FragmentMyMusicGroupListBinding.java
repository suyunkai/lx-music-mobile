...
public final class FragmentMyMusicGroupListBinding implements ViewBinding {
    ...
    private FragmentMyMusicGroupListBinding(FrameLayout rootView, EmptyViewBinding emptyView, MaterialAutoRefreshLayout meterialAutoRefreshLayout, RecyclerView recyclerviewMusicGroupList) {
    ...
    public static FragmentMyMusicGroupListBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static FragmentMyMusicGroupListBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.fragment_my_music_group_list, parent, false);
        if (attachToParent) {
    ...
    public static FragmentMyMusicGroupListBinding bind(View rootView) {
        ...
        if (viewFindChildViewById != null) {
            ...
            if (materialAutoRefreshLayout != null) {
                i2 = R.id.recyclerview_music_group_list;
                RecyclerView recyclerView = (RecyclerView) ViewBindings.findChildViewById(rootView, R.id.recyclerview_music_group_list);
                if (recyclerView != null) {
                    return new FragmentMyMusicGroupListBinding((FrameLayout) rootView, emptyViewBindingBind, materialAutoRefreshLayout, recyclerView);
                }
            }
            i = i2;
        }
