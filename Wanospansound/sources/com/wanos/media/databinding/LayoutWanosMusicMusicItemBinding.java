...
public final class LayoutWanosMusicMusicItemBinding implements ViewBinding {
    ...
    private LayoutWanosMusicMusicItemBinding(ConstraintLayout rootView, CardView cardBgView, CardView cdMusicBg, FrameLayout flCollectView, FrameLayout flIndexView, ImageView imMusicBg, ImageView imPalyingStatus, ImageView ivCollect, ImageView ivVip, LinearLayout llSinger, TextView tvMusicName, TextView tvMusicNum, TextView tvMusicTime, TextView tvSingerName) {
    ...
    public static LayoutWanosMusicMusicItemBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static LayoutWanosMusicMusicItemBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.layout_wanos_music_music_item, parent, false);
        if (attachToParent) {
    ...
    public static LayoutWanosMusicMusicItemBinding bind(View rootView) {
                                            ...
                                            if (textView != null) {
                                                ...
                                                if (textView2 != null) {
                                                    ...
                                                    if (textView3 != null) {
                                                        ...
                                                        if (textView4 != null) {
                                                            return new LayoutWanosMusicMusicItemBinding((ConstraintLayout) rootView, cardView, cardView2, frameLayout, frameLayout2, imageView, imageView2, imageView3, imageView4, linearLayout, textView, textView2, textView3, textView4);
                                                        }
                                                    }
                                                }
                                            }
