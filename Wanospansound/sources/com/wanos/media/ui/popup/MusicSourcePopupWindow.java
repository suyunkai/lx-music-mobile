package com.wanos.media.ui.popup;
...
public class MusicSourcePopupWindow extends PopupWindow {
    ...
    private void init() {
        ...
        popRecyclerView.setLayoutManager(new LinearLayoutManager(this.context) { // from class: com.wanos.media.ui.popup.MusicSourcePopupWindow.1
        ...
        popRecyclerView.addOnWindowFocusChanged(new PopRecyclerView.PopupWindowFocusChanged() { // from class: com.wanos.media.ui.popup.MusicSourcePopupWindow$$ExternalSyntheticLambda0
            @Override // com.flyme.auto.music.source.PopRecyclerView.PopupWindowFocusChanged
            public final void onWindowFocusChanged(boolean z) {
                this.f$0.m526lambda$init$0$comwanosmediauipopupMusicSourcePopupWindow(z);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$init$0$com-wanos-media-ui-popup-MusicSourcePopupWindow, reason: not valid java name */
    /* synthetic */ void m526lambda$init$0$comwanosmediauipopupMusicSourcePopupWindow(boolean z) {
        if (z) {
            return;
        }
        dismiss();
    ...
    class MusicSourceViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final MusicSourceEntity musicSourceEntity, final int i) {
            ...
            this.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.wanos.media.ui.popup.MusicSourcePopupWindow$MusicSourceViewHolder$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.m527xae862d0b(i, musicSourceEntity, view);
                }
            });
            textView.setTextColor(MusicSourcePopupWindow.this.textColor);
        }

        /* JADX INFO: renamed from: lambda$bind$0$com-wanos-media-ui-popup-MusicSourcePopupWindow$MusicSourceViewHolder, reason: not valid java name */
        /* synthetic */ void m527xae862d0b(int i, MusicSourceEntity musicSourceEntity, View view) {
    ...
    class MusicSourceAdapter extends RecyclerView.Adapter<MusicSourceViewHolder> {
        ...
        public MusicSourceViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            MusicSourcePopupWindow musicSourcePopupWindow = MusicSourcePopupWindow.this;
            Objects.requireNonNull(musicSourcePopupWindow);
            return musicSourcePopupWindow.new MusicSourceViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.view_music_source_item, viewGroup, false));
        }
