...
import com.wanos.media.ui.widget.banner.holder.IViewHolder;
...
public abstract class BannerAdapter<T, VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> implements IViewHolder<T, VH> {
    ...
    public final void onBindViewHolder(VH vh, int i) {
        ...
        if (this.mOnBannerListener != null) {
            vh.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.wanos.media.ui.widget.banner.adapter.BannerAdapter$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.m563x1214bafc(t, realPosition, view);
                }
            });
        }
    }

    /* JADX INFO: renamed from: lambda$onBindViewHolder$0$com-wanos-media-ui-widget-banner-adapter-BannerAdapter, reason: not valid java name */
    /* synthetic */ void m563x1214bafc(Object obj, int i, View view) {
    ...
    public VH onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        vhOnCreateHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.wanos.media.ui.widget.banner.adapter.BannerAdapter$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.m564x292f4bbc(vhOnCreateHolder, view);
            }
        });
    ...
    /* JADX INFO: renamed from: lambda$onCreateViewHolder$1$com-wanos-media-ui-widget-banner-adapter-BannerAdapter, reason: not valid java name */
    /* synthetic */ void m564x292f4bbc(RecyclerView.ViewHolder viewHolder, View view) {
        if (this.mOnBannerListener != null) {
