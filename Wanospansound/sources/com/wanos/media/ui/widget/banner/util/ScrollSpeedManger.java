...
public class ScrollSpeedManger extends LinearLayoutManager {
    ...
    public void smoothScrollToPosition(RecyclerView recyclerView, RecyclerView.State state, int i) {
        LinearSmoothScroller linearSmoothScroller = new LinearSmoothScroller(recyclerView.getContext()) { // from class: com.wanos.media.ui.widget.banner.util.ScrollSpeedManger.1
