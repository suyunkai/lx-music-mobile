...
public class WanosTextView extends AppCompatTextView {
    ...
    public static class WanosTextViewState extends View.BaseSavedState {
        public static final Parcelable.Creator<WanosTextViewState> CREATOR = new Parcelable.Creator<WanosTextViewState>() { // from class: com.wanos.media.widget.WanosTextView.WanosTextViewState.1
