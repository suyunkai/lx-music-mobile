...
public final class FragmentRelaxCollectListBinding implements ViewBinding {
    ...
    public static FragmentRelaxCollectListBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentRelaxCollectListBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.fragment_relax_collect_list, viewGroup, false);
        if (z) {
    ...
    public static FragmentRelaxCollectListBinding bind(View view) {
        ...
        if (viewFindChildViewById != null) {
            ...
            if (viewFindChildViewById2 != null) {
                ...
                if (viewFindChildViewById3 != null) {
                    ...
                    i = R.id.refresh;
                    MaterialAutoRefreshLayout materialAutoRefreshLayout = (MaterialAutoRefreshLayout) ViewBindings.findChildViewById(view, i);
                    if (materialAutoRefreshLayout != null) {
                        i = R.id.rv_relax_list;
                        RecyclerView recyclerView = (RecyclerView) ViewBindings.findChildViewById(view, i);
                        if (recyclerView != null) {
                            return new FragmentRelaxCollectListBinding((ConstraintLayout) view, emptyViewBindingBind, errorBindingBind, fragmentLoadingBindingBind, materialAutoRefreshLayout, recyclerView);
                        }
                    }
                }
            }
