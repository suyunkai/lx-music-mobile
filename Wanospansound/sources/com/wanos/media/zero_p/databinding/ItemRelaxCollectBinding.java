...
public final class ItemRelaxCollectBinding implements ViewBinding {
    ...
    private ItemRelaxCollectBinding(ConstraintLayout constraintLayout, AppCompatImageView appCompatImageView, CardView cardView, AppCompatImageView appCompatImageView2, AppCompatImageView appCompatImageView3, AppCompatImageView appCompatImageView4, WanosTextView wanosTextView, com.wanos.media.ui.widget.WanosTextView wanosTextView2) {
    ...
    public static ItemRelaxCollectBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static ItemRelaxCollectBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.item_relax_collect, viewGroup, false);
        if (z) {
    ...
    public static ItemRelaxCollectBinding bind(View view) {
                        ...
                        if (appCompatImageView4 != null) {
                            ...
                            if (wanosTextView != null) {
                                ...
                                if (wanosTextView2 != null) {
                                    return new ItemRelaxCollectBinding((ConstraintLayout) view, appCompatImageView, cardView, appCompatImageView2, appCompatImageView3, appCompatImageView4, wanosTextView, wanosTextView2);
                                }
                            }
                        }
                    }
