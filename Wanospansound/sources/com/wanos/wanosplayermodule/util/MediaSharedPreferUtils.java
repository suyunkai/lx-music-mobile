...
public class MediaSharedPreferUtils {
    ...
    public static void putIsPlaying(boolean z) {
        putBoolean(Utils.getApp().getSharedPreferences(IS_PLAYING, 0), IS_PLAYING_KEY, z);
    }

    public static boolean getIsPlaying() {
        return getBoolean(Utils.getApp().getSharedPreferences(IS_PLAYING, 0), IS_PLAYING_KEY, false);
    }
}
