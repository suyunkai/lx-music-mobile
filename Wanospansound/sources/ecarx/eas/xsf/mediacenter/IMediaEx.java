...
public class IMediaEx implements Parcelable {
    public static final Parcelable.Creator<IMediaEx> CREATOR = new Parcelable.Creator<IMediaEx>() { // from class: ecarx.eas.xsf.mediacenter.IMediaEx.1
        @Override // android.os.Parcelable.Creator
        public final /* bridge */ /* synthetic */ IMediaEx[] newArray(int i) {
            return new IMediaEx[i];
        }

        @Override // android.os.Parcelable.Creator
        public final /* synthetic */ IMediaEx createFromParcel(Parcel parcel) {
            return new IMediaEx(parcel);
        }
    };
