...
public interface IVideoPlaybackInfo extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IVideoPlaybackInfo {
        private static final String DESCRIPTOR = "ecarx.xsf.mediacenter.IVideoPlaybackInfo";
        ...
        public static IVideoPlaybackInfo asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IVideoPlaybackInfo)) {
                return (IVideoPlaybackInfo) iInterfaceQueryLocalInterface;
            }
        ...
        static class a implements IVideoPlaybackInfo {

            /* JADX INFO: renamed from: a, reason: collision with root package name */
            public static IVideoPlaybackInfo f702a;

            /* JADX INFO: renamed from: b, reason: collision with root package name */
            private IBinder f703b;
            ...
            public final int getPlaybackStatus() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.f703b.transact(1, parcelObtain, parcelObtain2, 0) && Stub.getDefaultImpl() != null) {
            ...
            public final boolean isSupportCollect() throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (!this.f703b.transact(2, parcelObtain, parcelObtain2, 0) && Stub.getDefaultImpl() != null) {
            ...
            public final boolean isCollected() throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (!this.f703b.transact(3, parcelObtain, parcelObtain2, 0) && Stub.getDefaultImpl() != null) {
            ...
            public final boolean isSupportDownload() throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (!this.f703b.transact(4, parcelObtain, parcelObtain2, 0) && Stub.getDefaultImpl() != null) {
            ...
            public final boolean isDownloaded() throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (!this.f703b.transact(5, parcelObtain, parcelObtain2, 0) && Stub.getDefaultImpl() != null) {
            ...
            public final boolean isSupportVrCtrlPlayStatus() throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (!this.f703b.transact(6, parcelObtain, parcelObtain2, 0) && Stub.getDefaultImpl() != null) {
        ...
        public static boolean setDefaultImpl(IVideoPlaybackInfo iVideoPlaybackInfo) {
            if (a.f702a != null || iVideoPlaybackInfo == null) {
                return false;
            }
            a.f702a = iVideoPlaybackInfo;
            return true;
        }

        public static IVideoPlaybackInfo getDefaultImpl() {
            return a.f702a;
        }
    }
}
