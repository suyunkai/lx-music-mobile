...
class PathsKt__PathUtilsKt extends PathsKt__PathRecursiveFunctionsKt {
    ...
    public static final String getNameWithoutExtension(Path path) {
        ...
        Intrinsics.checkNotNullParameter(path, "<this>");
        Path fileName = path.getFileName();
        return (fileName == null || (string = fileName.toString()) == null || (strSubstringBeforeLast$default = StringsKt.substringBeforeLast$default(string, Consts.DOT, (String) null, 2, (Object) null)) == null) ? "" : strSubstringBeforeLast$default;
    }
    ...
    public static final String getInvariantSeparatorsPathString(Path path) {
        ...
        if (Intrinsics.areEqual(separator, BceConfig.BOS_DELIMITER)) {
            return path.toString();
        }
        String string = path.toString();
        Intrinsics.checkNotNullExpressionValue(separator, "separator");
        return StringsKt.replace$default(string, separator, BceConfig.BOS_DELIMITER, false, 4, (Object) null);
    }
