...
public final class UStringsKt {
    ...
    public static final String m2030toStringLxnNnR4(byte b2, int i) {
    ...
    public static final String m2032toStringolVBNx4(short s, int i) {
    ...
    public static final String m2031toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m2029toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compareUnsigned(data, UInt.m813constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m730boximpl(UByte.m736constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m813constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m993boximpl(UShort.m999constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM813constructorimpl = UInt.m813constructorimpl(i);
        ...
        while (i2 < length) {
            ...
            if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                if (iDivideUnsigned == 119304647) {
                    iDivideUnsigned = Integer.divideUnsigned(-1, iM813constructorimpl);
                    if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            int iM813constructorimpl2 = UInt.m813constructorimpl(i3 * iM813constructorimpl);
            int iM813constructorimpl3 = UInt.m813constructorimpl(UInt.m813constructorimpl(iDigitOf) + iM813constructorimpl2);
            if (Integer.compareUnsigned(iM813constructorimpl3, iM813constructorimpl2) < 0) {
                return null;
            }
            i2++;
            i3 = iM813constructorimpl3;
        }
        return UInt.m807boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM892constructorimpl = ULong.m892constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                if (jDivideUnsigned == 512409557603043100L) {
                    jDivideUnsigned = Long.divideUnsigned(-1L, jM892constructorimpl);
                    if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            long jM892constructorimpl2 = ULong.m892constructorimpl(j * jM892constructorimpl);
            long jM892constructorimpl3 = ULong.m892constructorimpl(ULong.m892constructorimpl(((long) UInt.m813constructorimpl(iDigitOf)) & 4294967295L) + jM892constructorimpl2);
            if (Long.compareUnsigned(jM892constructorimpl3, jM892constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j = jM892constructorimpl3;
        }
        return ULong.m886boximpl(j);
    }
}
