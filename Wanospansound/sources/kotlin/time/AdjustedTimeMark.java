...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo2034minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m2180minusLRDsOJo(this, j);
    }
    ...
    public long mo2033elapsedNowUwyO8pc() {
        return Duration.m2079minusLRDsOJo(this.mark.mo2033elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    public TimeMark mo2036plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m2080plusLRDsOJo(this.adjustment, duration), null);
    }
}
