...
public final class DurationKt {
    ...
    private static final long m2170timesmvk6XK0(int i, long j) {
        return Duration.m2082timesUwyO8pc(j, i);
    }

    /* JADX INFO: renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m2169timeskIfJnKk(double d2, long j) {
        return Duration.m2081timesUwyO8pc(j, d2);
    }
    ...
    */
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m2044constructorimpl(j << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m2044constructorimpl((j << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m2044constructorimpl((j << 1) + ((long) i));
    }
