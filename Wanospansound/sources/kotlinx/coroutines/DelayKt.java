...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2271scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m2207delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m2208toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2208toDelayMillisLRDsOJo(long j) {
        if (Duration.m2043compareToLRDsOJo(j, Duration.INSTANCE.m2146getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m2062getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
