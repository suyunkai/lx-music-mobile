...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo2223receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo2223receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo2224tryReceivePtdJZtk() {
        return this._channel.mo2224tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* JADX INFO: renamed from: trySend-JP2dKIU */
    public Object mo2225trySendJP2dKIU(E element) {
        return this._channel.mo2225trySendJP2dKIU(element);
    }
