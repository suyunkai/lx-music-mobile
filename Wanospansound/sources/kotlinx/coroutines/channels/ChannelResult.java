...
public final class ChannelResult<T> {
    ...
    public static final /* synthetic */ ChannelResult m2230boximpl(Object obj) {
        return new ChannelResult(obj);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static <T> Object m2231constructorimpl(Object obj) {
        return obj;
    }
    ...
    public static int m2237hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public int hashCode() {
        return m2237hashCodeimpl(this.holder);
    }
    ...
    public static final boolean m2240isSuccessimpl(Object obj) {
        return !(obj instanceof Failed);
    }

    /* JADX INFO: renamed from: isFailure-impl, reason: not valid java name */
    public static final boolean m2239isFailureimpl(Object obj) {
        return obj instanceof Failed;
    }

    /* JADX INFO: renamed from: isClosed-impl, reason: not valid java name */
    public static final boolean m2238isClosedimpl(Object obj) {
        return obj instanceof Closed;
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: getOrNull-impl, reason: not valid java name */
    public static final T m2235getOrNullimpl(Object obj) {
    ...
    public static final T m2236getOrThrowimpl(Object obj) throws Throwable {
        if (!(obj instanceof Failed)) {
            return obj;
        }
    ...
    public static final Throwable m2234exceptionOrNullimpl(Object obj) {
    ...
    public static final class Companion {
        ...
        public final <E> Object m2245successJP2dKIU(E value) {
            return ChannelResult.m2231constructorimpl(value);
        }

        /* JADX INFO: renamed from: failure-PtdJZtk, reason: not valid java name */
        public final <E> Object m2244failurePtdJZtk() {
            return ChannelResult.m2231constructorimpl(ChannelResult.failed);
        }

        /* JADX INFO: renamed from: closed-JP2dKIU, reason: not valid java name */
        public final <E> Object m2243closedJP2dKIU(Throwable cause) {
            return ChannelResult.m2231constructorimpl(new Closed(cause));
        }
    }

    public String toString() {
        return m2241toStringimpl(this.holder);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m2241toStringimpl(Object obj) {
