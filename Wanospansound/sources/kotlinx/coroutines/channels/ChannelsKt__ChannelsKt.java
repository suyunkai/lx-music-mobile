...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            try {
                ...
                objM718constructorimpl = Result.m718constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM718constructorimpl = Result.m718constructorimpl(ResultKt.createFailure(th));
            }
            return ChannelResult.m2230boximpl(Result.m725isSuccessimpl(objM718constructorimpl) ? ChannelResult.INSTANCE.m2245successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m2243closedJP2dKIU(Result.m721exceptionOrNullimpl(objM718constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo2225trySendJP2dKIU = sendChannel.mo2225trySendJP2dKIU(e);
        if (objMo2225trySendJP2dKIU instanceof ChannelResult.Failed) {
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m2240isSuccessimpl(sendChannel.mo2225trySendJP2dKIU(e))) {
            return;
        }
