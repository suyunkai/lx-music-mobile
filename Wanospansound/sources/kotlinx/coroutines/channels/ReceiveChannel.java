...
public interface ReceiveChannel<E> {
    ...
    Object mo2223receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo2224tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo2224tryReceivePtdJZtk = receiveChannel.mo2224tryReceivePtdJZtk();
            if (ChannelResult.m2240isSuccessimpl(objMo2224tryReceivePtdJZtk)) {
                return (E) ChannelResult.m2236getOrThrowimpl(objMo2224tryReceivePtdJZtk);
            }
            Throwable thM2234exceptionOrNullimpl = ChannelResult.m2234exceptionOrNullimpl(objMo2224tryReceivePtdJZtk);
            if (thM2234exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM2234exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) throws java.lang.Throwable {
            ...
            L38:
                kotlin.ResultKt.throwOnFailure(r5)
                r0.label = r3
                java.lang.Object r4 = r4.mo2223receiveCatchingJP2dKIU(r0)
                if (r4 != r1) goto L44
                return r1
            L44:
                java.lang.Object r4 = kotlinx.coroutines.channels.ChannelResult.m2235getOrNullimpl(r4)
                return r4
            */
