...
public interface SendChannel<E> {
    ...
    Object mo2225trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m2240isSuccessimpl(objMo2225trySendJP2dKIU)) {
                return true;
            }
            Throwable thM2234exceptionOrNullimpl = ChannelResult.m2234exceptionOrNullimpl(objMo2225trySendJP2dKIU);
