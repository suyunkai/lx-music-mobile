...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM718constructorimpl = Result.m718constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM718constructorimpl = Result.m718constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m724isFailureimpl(objM718constructorimpl) ? null : objM718constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m2247installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m2247installSignalHandler$lambda1(Signal signal) {
