...
public final class DebugProbesImpl {
    ...
    private final Function1<Boolean, Unit> getDynamicAttach() {
        ...
        try {
            ...
            objM718constructorimpl = Result.m718constructorimpl(ResultKt.createFailure(th));
        }
        if (objNewInstance != null) {
            objM718constructorimpl = Result.m718constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(objNewInstance, 1));
            if (Result.m724isFailureimpl(objM718constructorimpl)) {
                objM718constructorimpl = null;
            }
            return (Function1) objM718constructorimpl;
        }
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String state, Thread thread, List<StackTraceElement> coroutineTrace) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            DebugProbesImpl debugProbesImpl = this;
            objM718constructorimpl = Result.m718constructorimpl(thread.getStackTrace());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM718constructorimpl = Result.m718constructorimpl(ResultKt.createFailure(th));
        }
        ...
        StackTraceElement[] stackTraceElementArr = (StackTraceElement[]) objM718constructorimpl;
