...
public final class FlowKt__BuildersKt$flowOf$$inlined$unsafeFlow$1<T> implements Flow<T> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$flowOf$$inlined$unsafeFlow$1", f = "Builders.kt", i = {0, 0}, l = {114}, m = WanosJsBridge.METHOD_KEY_COLLECT, n = {"this", "$this$flowOf_u24lambda_u2d8"}, s = {"L$0", "L$1"})
