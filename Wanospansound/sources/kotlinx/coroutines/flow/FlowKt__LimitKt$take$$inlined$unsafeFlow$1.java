...
public final class FlowKt__LimitKt$take$$inlined$unsafeFlow$1<T> implements Flow<T> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__LimitKt$take$$inlined$unsafeFlow$1", f = "Limit.kt", i = {0}, l = {115}, m = WanosJsBridge.METHOD_KEY_COLLECT, n = {"$this$take_u24lambda_u2d4"}, s = {"L$0"})
