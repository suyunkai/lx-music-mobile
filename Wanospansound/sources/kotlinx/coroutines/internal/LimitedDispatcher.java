...
public final class LimitedDispatcher extends CoroutineDispatcher implements Runnable, Delay {
    ...
    public void mo2271scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        this.$$delegate_0.mo2271scheduleResumeAfterDelay(timeMillis, continuation);
    }
    ...
    */
    ...
    public void mo2270dispatch(CoroutineContext context, Runnable block) {
        ...
        this.dispatcher.mo2270dispatch(this, this);
    }
