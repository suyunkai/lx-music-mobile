...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM718constructorimpl2;
        Object obj = stackTraceRecoveryClass;
        Object obj2 = baseContinuationImplClass;
        try {
            Result.Companion companion = Result.INSTANCE;
            objM718constructorimpl = Result.m718constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM718constructorimpl = Result.m718constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m721exceptionOrNullimpl(objM718constructorimpl) == null) {
            obj2 = objM718constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM718constructorimpl2 = Result.m718constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM718constructorimpl2 = Result.m718constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m721exceptionOrNullimpl(objM718constructorimpl2) == null) {
            obj = objM718constructorimpl2;
        }
