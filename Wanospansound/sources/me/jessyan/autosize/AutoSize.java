...
public final class AutoSize {
    ...
    public static void autoConvertDensity(Activity activity, float f, boolean z) {
        ...
        int iRound = Math.round((f + designHeight + screenHeight) * AutoSizeConfig.getInstance().getInitScaledDensity()) & LockFreeTaskQueueCore.MAX_CAPACITY_MASK;
        int i = z ? iRound | 1073741824 : iRound & (-1073741825);
