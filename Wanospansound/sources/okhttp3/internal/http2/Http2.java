...
public final class Http2 {
    ...
    static {
        ...
        for (int i = 0; i < 256; i++) {
            ...
            strArr[i] = StringsKt.replace$default(_UtilJvmKt.format("%8s", binaryString), TokenParser.SP, '0', false, 4, (Object) null);
        }
        BINARY = strArr;
