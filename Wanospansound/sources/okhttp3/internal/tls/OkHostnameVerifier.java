...
public final class OkHostnameVerifier implements HostnameVerifier {
    ...
    private final boolean verifyHostname(String hostname, String pattern) {
        String str = hostname;
        if (!(str == null || str.length() == 0) && !StringsKt.startsWith$default(hostname, Consts.DOT, false, 2, (Object) null) && !StringsKt.endsWith$default(hostname, "..", false, 2, (Object) null)) {
            String str2 = pattern;
            if (!(str2 == null || str2.length() == 0) && !StringsKt.startsWith$default(pattern, Consts.DOT, false, 2, (Object) null) && !StringsKt.endsWith$default(pattern, "..", false, 2, (Object) null)) {
                if (!StringsKt.endsWith$default(hostname, Consts.DOT, false, 2, (Object) null)) {
                    hostname = hostname + '.';
                }
                if (!StringsKt.endsWith$default(pattern, Consts.DOT, false, 2, (Object) null)) {
                    pattern = pattern + '.';
                }
