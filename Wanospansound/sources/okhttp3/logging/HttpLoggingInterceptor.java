...
public final class HttpLoggingInterceptor implements Interceptor {
    ...
    public Response intercept(Interceptor.Chain chain) throws Exception {
        ...
        try {
            ...
            logger.log(sbAppend.append(string).append(c2).append(responseProceed.request().url()).append(" (").append(millis).append("ms").append(!z2 ? ", " + str3 + " body" : "").append(')').toString());
            if (z2) {
                ...
                if (!z || !HttpHeaders.promisesBody(responseProceed)) {
                    ...
                    MediaType mediaType = responseBodyBody.getMediaType();
