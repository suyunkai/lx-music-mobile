...
public final class _UtilKt {
    ...
    public static final String toHexString(byte b2) {
        return StringsKt.concatToString(new char[]{_ByteStringKt.getHEX_DIGIT_CHARS()[(b2 >> 4) & 15], _ByteStringKt.getHEX_DIGIT_CHARS()[b2 & Ascii.SI]});
    }
