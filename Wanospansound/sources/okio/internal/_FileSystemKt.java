...
public final class _FileSystemKt {
    ...
    static final class C02881 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super Path>, Continuation<? super Unit>, Object> {
        ...
        C02881(Path path, FileSystem fileSystem, boolean z, Continuation<? super C02881> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C02881 c02881 = new C02881(this.$dir, this.$this_commonListRecursively, this.$followSymlinks, continuation);
            c02881.L$0 = obj;
            return c02881;
        }
        ...
        public final Object invoke(SequenceScope<? super Path> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C02881) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            while (it.hasNext()) {
                Path next = it.next();
                c02881.L$0 = sequenceScope;
                c02881.L$1 = arrayDeque;
                c02881.L$2 = it;
                c02881.label = 1;
                if (_FileSystemKt.collectRecursively(sequenceScope, c02881.$this_commonListRecursively, arrayDeque, next, c02881.$followSymlinks, false, c02881) == coroutine_suspended) {
    ...
    public static final Sequence<Path> commonListRecursively(FileSystem fileSystem, Path dir, boolean z) throws IOException {
        Intrinsics.checkNotNullParameter(fileSystem, "<this>");
        Intrinsics.checkNotNullParameter(dir, "dir");
        return SequencesKt.sequence(new C02881(dir, fileSystem, z, null));
    }
