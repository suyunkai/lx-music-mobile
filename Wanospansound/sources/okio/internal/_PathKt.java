...
public final class _PathKt {
    private static final ByteString SLASH = ByteString.INSTANCE.encodeUtf8(BceConfig.BOS_DELIMITER);
    ...
    private static final ByteString DOT = ByteString.INSTANCE.encodeUtf8(Consts.DOT);
    ...
    public static final Path commonRelativeTo(Path path, Path other) {
        ...
        return Path.Companion.get$default(Path.INSTANCE, Consts.DOT, false, 1, (Object) null);
    }
    ...
    public static final ByteString toSlash(String str) {
        if (Intrinsics.areEqual(str, BceConfig.BOS_DELIMITER)) {
            return SLASH;
        }
