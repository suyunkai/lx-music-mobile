...
public class BlockJUnit4ClassRunnerWithParameters extends BlockJUnit4ClassRunner {
    ...
    private Object createTestUsingFieldInjection() throws Exception {
        ...
        if (annotatedFieldsByParameter.size() != this.parameters.length) {
            throw new Exception("Wrong number of parameters and @Parameter fields. @Parameter fields counted: " + annotatedFieldsByParameter.size() + ", available parameters: " + this.parameters.length + Consts.DOT);
        }
        ...
        if (getInjectionType() == InjectionType.FIELD) {
            ...
            while (it.hasNext()) {
                ...
                if (iValue < 0 || iValue > annotatedFieldsByParameter.size() - 1) {
                    list.add(new Exception("Invalid @Parameter value: " + iValue + ". @Parameter fields counted: " + annotatedFieldsByParameter.size() + ". Please use an index between 0 and " + (annotatedFieldsByParameter.size() - 1) + Consts.DOT));
                } else {
